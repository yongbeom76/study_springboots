...
<c:forEach items="${resultMap.attachFiles}" var="resultData" varStatus="loop">
	<div class="form-group form-row">
		...
		<a href="/files/${resultMap.PHYSICALFILE_NAME}/${resultData.ORIGINALFILE_NAME}">resultData.ORIGINALFILE_NAME</a>
		<input type="hidden" name="${loop.index}" value="${resultData.ATTACHFILE_SEQ}"/>
	</div>
</c:forEach>
